...
import "../src/VedyxVotingContract.sol";
...
contract AccessControlTest is Test {
    ...
    function test_Constructor_GrantsAllRolesToDeployer() public {
    ...
    function test_RoleConstants_AreCorrect() public {
    ...
    function test_TreasuryRole_CanTransferFeesToTreasury() public {
        ...
        uint256 votingId = votingContract.tagSuspicious(makeAddr("suspicious"), 1, address(0x123), 1000 ether, 18, 12345);
