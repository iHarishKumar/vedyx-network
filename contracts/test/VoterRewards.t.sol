...
contract VoterRewardsTest is Test {
    ...
    function test_RewardDistribution_WithKarmaBonus() public {
        ...
        // Warp past the second voting's end time
    ...
    function test_RewardDistribution_FourVotersMixedOutcome() public {
        ...
        uint256 totalStakesAfter = stakeUser1After.stakedAmount + stakeUser2After.stakedAmount
            + stakeUser3After.stakedAmount + stakeUser4After.stakedAmount;
